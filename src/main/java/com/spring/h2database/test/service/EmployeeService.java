...
import com.spring.h2database.test.exception.RecordNotFoundException;
...
public class EmployeeService {
    ...
    public void callStoredProcedure(Long employeeId) {
        String sql = "CALL GET_EMPLOYEE(?)";
        jdbcTemplate.query(sql, new Object[]{employeeId}, rs -> { });
    }
}